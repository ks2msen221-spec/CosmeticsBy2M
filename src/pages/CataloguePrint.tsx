...
export default function CataloguePrint() {
  ...
  return (
    <div className="min-h-screen bg-white p-6 md:p-12 text-black font-sans selection:bg-brand-taupe/20">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="no-print flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-brand-cream border border-black/5 p-4 mb-8">
          <Link 
          ...
          <button 
            onClick={handlePrint}
            className="px-6 py-3 bg-brand-noir hover:bg-brand-gold text-brand-cream hover:text-brand-noir text-[10px] uppercase tracking-widest font-bold transition-colors flex items-center justify-center gap-2 cursor-pointer shadow-sm"
          >
            ...
            <div className="space-y-6">
              {products.map((product, idx) => (
                <div key={product.id} className="print-card border-b border-black/5 pb-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-brand-cream p-3 border border-black/5 rounded-sm font-mono text-[9px] leading-relaxed text-black/70">
                    <div>
