    ...
    <div className="w-full bg-brand-cream min-h-screen">
        ...
        <div className="w-full lg:w-1/2 relative bg-brand-cream/80 p-8 md:p-16 flex items-center justify-center min-h-[450px]">
          <div className="w-full max-w-[420px] aspect-[4/5] bg-black/5 shadow-2xl relative overflow-hidden group rounded-sm">
            ...
            <div className="absolute bottom-8 left-8 right-8 text-white">
              ...
              <p className="text-2xl font-serif italic">Des Sérums Simples & Équilibrants</p>
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-12 py-20">
        <div className="text-center mb-16 max-w-2xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl font-serif text-black/90">Trouvez le produit adapté à vos besoins</h2>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
            <div className="max-w-xl">
              ...
              <h2 className="text-3xl md:text-4xl font-serif text-black/90">Les produits préférés de nos clientes</h2>
